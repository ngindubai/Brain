...
From "The Humanless Company" build plan, 19 June. The design behind running a whole company with no humans in the seats. Companion to [[Agent Behaviour Design]] ("The Glass Office"). Part of [[Agent Org]].
...
Build it first, before any agent. See [[Warehouse Architecture]].
