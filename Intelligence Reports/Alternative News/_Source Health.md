...
| Declassified UK | 11 August 2026 | BLOCKED | 403 on homepage and /feed/ again, no change in failure mode. Twenty-first consecutive blocked occurrence. Checked for a republication workaround (ScheerPost, Palestine Uncensored, Morning Star, the pattern used successfully on 3 and 7 August) and found nothing dated today. Flag unanswered since 20 July across twenty-one reports now. Still needs Gareth's direct call: extend, downgrade to T2, or retire alongside Consortium News. |
