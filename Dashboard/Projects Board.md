...
Every active project at a glance. Kept current by the daily ritual. Open a project's note for detail.

| Project | Priority | Status | Next action |
|---|---|---|---|
| [[Marketing Department]] | P1 | Plan done, build on mock data | Five manual tasks, then run B1 |
...
At the end of each day, ask me to summarise the day and plan tomorrow. I update each tracker and this board, write the daily note, and list tomorrow's actions. See [[Daily Summary]].
