...
tags: [github-database, repos, skills, tools, moc, master-list]
updated: 2026-06-23
---
...
- One file per category in `github-database/`, named after the category.
...
|---|---|---|
| Agent frameworks | Self-hosted agent runtimes and orchestration | [[github-database/agent-frameworks]] |
| MCP servers | Model Context Protocol connectors | [[github-database/mcp-servers]] |
| Skill libraries | Reusable agent skills (agentskills.io etc) | [[github-database/skill-libraries]] |
| Web design | Animation, scroll, 3D, frontend craft | [[github-database/web-design]] |
| Automation tools | Browser automation, scraping, pipelines | [[github-database/automation-tools]] |
