...
tags: [github-database, web-design, animation, scroll, frontend]
updated: 2026-06-23
---

# Web Design

Animation, scroll, 3D and frontend-craft repos. The toolkit behind premium, motion-rich sites, the kind agencies charge $6k-35k for. Back to [[github-database/github-database]]. Paired research: [[research/advanced-web-design]].

| Repo / Source | What it is | What we'd pull | Feeds | Status |
|---|---|---|---|---|
| [darkroomengineering/lenis](https://github.com/darkroomengineering/lenis) | ~3kB smooth-scroll library (formerly Studio Freight). Production standard. Runs on native scroll, React/Vue/Framer adapters, snap plugin. Drop-in via CDN, no build step | The smooth-scroll layer for every motion site. Improves INP/Core Web Vitals too | [[areas/products/products]], [[areas/seo-portfolio/seo-portfolio]] | using |
| [greensock/GSAP](https://github.com/greensock/GSAP) | Industry-standard JS animation library. ScrollTrigger (positional scroll math), ScrollSmoother, timelines, custom eases | The animation engine. Pairs with Lenis on one ticker | [[areas/products/products]] | using |
...
| [AKCodez Higgsfield UGC pipeline gist](https://gist.github.com/AKCodez/0d3f9874d0e147bd75a097ca0cc1dcc3) | Full Claude Code + Higgsfield + Playwright UGC automation: custom skills, CLAUDE.md rules, batch generation | The skills + CLAUDE.md + Playwright pattern for repeatable asset pipelines | [[areas/products/products]] | evaluating |
