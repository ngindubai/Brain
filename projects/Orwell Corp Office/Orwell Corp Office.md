...
Area: [[Products]]. Design target: [[Agent Behaviour Design]] (the glass office).
...
Done: ~1,045-object scene built and exported (orwell-office-optionB.glb). R3F loader and the third toggle wired and deploying. Lighting and tone-mapping pass done.

Frontier: Swap scripted primitives for designed CC0 assets (Poly Pizza, Quaternius, Kenney). Blender needed a restart after the freeze.
