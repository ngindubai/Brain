...
- PetTransport: 114 hard 404s and roughly 1,069 not-indexed despite being highest traffic.
...
- CloseProtection robots.txt was bare and fixed to the Repat/Pet pattern.
- BusRentalGlobal canonical script rewritten to clean directory URLs; needs a local re-run and push.
- Branch care: closeprotection uses master, pet-transport uses main.

## Progress

Done: Action plan built. BusRental canonical script fixed. CloseProtection robots.txt fixed. Live Windsor GA4 and GSC data flowing.

Frontier: RepatriationFuneral canonical and duplication repair. PetTransport 404 cleanup. GSC console submissions.
